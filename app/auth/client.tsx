...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create FlowCRM Account",
        description: "Start your free FlowCRM workspace in under a minute.",
      };
    }

    return {
      id: "signin",
      title: "Sign in to FlowCRM",
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Power up your internal CRM in minutes.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Secure authentication, robust onboarding, and a production-grade interface built for your business.
              </p>
            </div>
